            ...
            <div class="zerogrid">
                <div class="col-3-3 ">
                    <div class="intro-header">
                        <h2><?php echo $_SESSION['err'] ? "SOMETHING WENT WRONG" : "SUCCESS!"; ?></h2>
                    </div>
                    <div class="wrap-col intro-wrap">
                        <div class="row">
                            <div class="col-1-2">
                                <div class='embed-container'><iframe src="https://www.youtube.com/embed/vu-y1FtOKj4?rel=0&amp;controls=1&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
                                </div>
                            </div>
                            <div class="col-1-2 ">
                                <ul>
                                    <li class="intro-body">
                                        <?php echo $_SESSION['err'] ? "<p>" . str_replace('Array', '', print_r($_SESSION['err'], true)) . "</p>" : "Our systems have been successfully updated with your information!"; ?>
                                    </li>
                                    <li class="intro-body">
                                        <?php echo $_SESSION['err'] ? "Please try again." : 'You may begin or resume shopping by clicking "Log in" at the upper right hand corner.'; ?>
                                    </li>
                                </ul>
                            </div>
                        </div>
