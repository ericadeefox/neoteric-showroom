...
<body>
 ...
 include_once("include/neoteric_conversion.inc");
    ...
    $options = array('dbTraining'=>"<b>Training & Documentation</b></br> <span  class=\"tabinner\">Documents, certifications, and training in hovercraft flight & manufacturing.</span>");
    ...
    foreach ($options as $key=>$option) {
        ...
        print "<li><h3>Training & Documentation</h3></li>";
