...
<body>
 ...
 include_once("include/neoteric_conversion.inc");
    ...
    $options = array('dbBodyMarine'=>"<b>Body & Marine Equipment</b></br> <span  class=\"tabinner\">Body & marine equipment, including cabin equipment, covering, fiberglass & glass, and trailering add-ons.</span>");
    ...
    foreach ($options as $key=>$option) {
        ...
        print "<li><h3>Body & Marine Equipment</h3></li>";
