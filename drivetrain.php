...
<body>
 ...
 include_once("include/neoteric_conversion.inc");
    ...
    $options = array('dbDrivetrain'=>"<b>Drivetrain & Fuel Sytems</b></br> <span  class=\"tabinner\">Drivetrain & fuel system equipment, including engines, fuel gauges, and fuel systems.</span>");
    ...
    foreach ($options as $key=>$option) {
        ...
        print "<li><h3>Drivetrain & Fuel Systems</h3></li>";
