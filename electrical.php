...
<body>
 ...
 include_once("include/neoteric_conversion.inc");
    ...
    $options = array('dbElectrical'=>"<b>Lighting & Electrical</b></br> <span  class=\"tabinner\">Lighting & electrical equipment, including lights, sirens, and other electrical components for the Hovertrek.</span>");
    ...
    foreach ($options as $key=>$option) {
        ...
        //print he table header information
        print "<div class=\"parts-table\" id=\"$key-section\"><div class=\"wrap-col\" align=\"center\" style=\"margin: 0px;\"><div class=\"col-3-3\"><p style=\"background-color:#3b3b3b; color:#fff; margin:0px; padding:10px; \">$option</p></div></div>";

        print "<ul class=\"paginator\">\n";
        print "<li><h3>Lighting & Electrical</h3></li>";
        ...
        echo '<div class="cart-box">
					...
					<div id="contact_form">';
        foreach ($rows as $row) {
            echo '<p id="cart-box' . $row['dbPartNumber'] . '"></p>';
        };
        echo '</div>
				</div>';
